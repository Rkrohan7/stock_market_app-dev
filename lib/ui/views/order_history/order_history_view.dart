...
class OrderHistoryView extends StackedView<OrderHistoryViewModel> {
  ...
  @override
  Widget builder(BuildContext context, OrderHistoryViewModel viewModel, Widget? child) {
    return Scaffold(
      appBar: AppBar(
                    ...
                    child: viewModel.orders.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return _buildOrderCard(context, viewModel, order, index);
                            },
                          ),
                  ),
                ],
  ...
  Widget _buildFilterChips(BuildContext context, OrderHistoryViewModel viewModel) {
    return Container(
  ...
  Widget _buildOrderCard(BuildContext context, OrderHistoryViewModel viewModel, OrderModel order, int index) {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  _buildDetailItem('Price', Formatters.formatCurrency(order.price)),
                  _buildDetailItem('Total', Formatters.formatCurrency(order.totalValue)),
                  _buildDetailItem('Type', order.orderType.name.toUpperCase()),
                ],
              ),
              const SizedBox(height: 12),
              Row(
  ...
  @override
  void onViewModelReady(OrderHistoryViewModel viewModel) => viewModel.initialize();
}
